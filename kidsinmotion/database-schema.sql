-- Database schema for KidsInMotion application
...
CREATE TABLE users (
    ...
    role VARCHAR(20) NOT NULL, -- ADMIN, VOLUNTEER, PARENT
...
CREATE TABLE events (
    ...
    description TEXT,
    event_type VARCHAR(50) NOT NULL, -- CLINIC only
    sport_type VARCHAR(50) NOT NULL,  -- BASEBALL, SOCCER, BASKETBALL, etc.

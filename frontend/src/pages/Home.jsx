        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="testimonial-slider ">
            <div className="testimonial text-center">
              ...
              <p style={{ fontSize: '1.25rem', color: 'white', maxWidth: '800px', margin: '1.5rem auto', padding: '1rem' }}>
                "Kids in Motion has transformed our community by giving every child the opportunity to discover their passion for sports. Through free clinics and equipment donations, we're building confidence, teaching teamwork, and creating lasting friendships that extend far beyond the playing field."
              </p>

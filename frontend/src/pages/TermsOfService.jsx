        ...
        <div className="container">
          <div className="card">
            ...
            <div className="card-body" style={{ lineHeight: '1.6' }}>
              ...
              <h3>3.2 Age Requirements and Child Protection</h3>
              <ul>
                <li>Users under 13 must have verifiable parental consent to create an account (COPPA compliance)</li>
                <li>Parents/guardians are responsible for supervising their minor children's use of the Service</li>
                <li>We do not knowingly collect personal information from children under 13 without parental consent</li>
                <li>Volunteers must be at least 14 years old or have appropriate adult supervision</li>
                <li>All adults working with minors must complete background checks as required by law</li>
              </ul>
              ...
              <p>
                These Terms shall be governed by and construed in accordance with the laws of the Commonwealth of Pennsylvania, without regard to conflict of law principles. Any disputes arising under these Terms shall be resolved through binding arbitration or in the courts of Pennsylvania.
              </p>
              ...
              <div style={{ marginLeft: '1rem' }}>
                <p><strong>Kids in Motion</strong></p>
